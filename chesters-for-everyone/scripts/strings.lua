local strings = {
	system = {
		...
		rename_usage = "Usage: /rename_chester <name>",
		name_too_long = "That name is too long!",
		companion_missing = "Oh no... Chester is missing!",
	},
	name_taken = {
	...
	private = {
		DEFAULT = "Hm, this is not my Chester.",
		wilson = "I shouldn't snoop around.",
		willow = "I can't play with this Chester.",
		wolfgang = "This is not Wolfgang's Chester.",
		wendy = "Locked? I don't have the energy for this.",
		wx78 = "ACCESS DENIED.",
		wickerbottom = "This is not mine to meddle with.",
		woodie = "This ain't my Chester, eh?",
		wes = "...",
	...
	rename = {
		...
		wormwood = "Chester now {name}. Good name.",
